    ...
    return (
        <div className='Footer flex flex-col gap-[10px] pt-[40px] lg:pt-[100px] bg-neutral-800 text-white'>
            <div className="footertop pad flex flex-col lg:flex-row gap-[30px] pb-[30px] lg:pb-[80px]">
                ...
                <div className="footer1 flex flex-col gap-[10px] lg:gap-[15px] lg:w-[25%]">
                    <div className="div mb-[5px] font-semibold text-orange-500">LOGO</div>
                ...
                <div className="footer2 flex flex-col gap-[20px] lg:w-[17%]">
                ...
                <div className="footer3 flex flex-col gap-[20px] lg:w-[33%]">
                ...
                <div className="footer4 flex flex-col gap-[10px] lg:w-[25%]">
                    ...
                    <div className="flex gap-[20px] lg:gap-[30px] text-[25px] text-orange-500">
