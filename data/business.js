import air1 from "../public/images/business/air/air4.jpg";
import air2 from "../public/images/business/air/air3.jpg";
import air3 from "../public/images/business/air/air1.jpg";
...
import agro2 from "../public/images/business/agro/agro2.jpg";
import agro3 from "../public/images/business/agro/agro3.jpeg";
import cargo1 from "../public/images/business/cargo/cargo1.jpg";
import cargo2 from "../public/images/business/cargo/cargo2.jpg";
import tel1 from "../public/images/business/tel/tel1.jpg";
import tel2 from "../public/images/business/tel/tel2.png";
...
export const businessList =  [
    {
        ...
        text:[
            {
                text: "National Airways Ethiopia, which is the nucleus for NIG, and its sister companies is the ﬁrst big private airline ever to engage in air transport services in Ethiopia. National Airways Ethiopia which was formerly called Air Ethiopia was established in 2008."
            },
            {
                text: "National Airways Ethiopia has been providing scheduled & charter passenger, charter cargo, and air ambulance, aircraft management and other aviation services to major domestic destinations within Ethiopia and key cities in the East Africa Region.National Airways Ethiopia is led by its owner and founder, Captain Abera Lemi, and a group of airlines executives who have collectively amassed more than 150 years of outstanding aviation experience by working in big air operators in Africa and Middle East: Ethiopian Airlines, ETIHAD Airways, and Qatar Airways. "
            },
            {
                text: "The human resource competencies coupled with outstanding passenger and cargo services provided over the years make National Airways Ethiopia a preferred private air operator in East Africa. National Airways Ethiopia has secured Air Operating Certiﬁcate (from Ethiopian Civil Aviation Authority and business license from Ministry of Trade."
            },
        ]
    },
    // air 
