    ...
    return (
        <div className='Header relative h-[300px] z-0 lg:h-[50vh] bg-neutral-700'>
            ...
            <div className="h-full w-full absolute top-[0px]  pad flex items-center lg:justify-start">
                <h2 className="capitalize text-white mt-[40px] lg:mt-[10px] text-[40px] lg:text-[55px] leading-[50px] lg:w-[60%] lg:leading-[75px]"><span className="text-primary1">{page}</span> {pageDescription} </h2>
            </div>
