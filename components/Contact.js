  ...
  return (
    <div className='ContactComp '>
      ...
      <div className="sectiontwocontact flex flex-col lg:flex-row gap-[40px] py-[40px] lg:pb-[100px] pad ">
        ...
        <div className="flex flex-col lg:flex-row lg:w-[79vw] gap-[20px] shadow-xl">
          ...
          <div className="h-[380px] lg:h-[608px] lg:full lg:w-[50%] relative overflow-hidden">
            <Image className="h-full w-full object-cover" height={1000} width={1000} priority src="/images/contact/possea.jpg" />
            <div className="ccmapped h-full w-full absolute px-[20px] text-white flex flex-col gap-[25px] text-[16px] justify-center lg:justify-start top-[0px] inset-0 bg-primary1 bg-opacity-[70%]">
            ...
            <div className="absolute bottom-[-30%] right-[-30%] bg-black h-[60%] w-[60%] rounded-full">
