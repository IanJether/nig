...
const SustainabilityComp = () => {
  return (
    <div className='SustainabilityComp'>
      ...
      <div className="sectionone h-[600px] lg:h-[100vh] relative">
        ...
        <div className="sustainabilitytext absolute inset-0 top-0 h-full w-full flex flex-col gap-[20px] mt-[10px] lg:gap-[30px] justify-center pad items-center text-white text-center">
          <div className="text-[16px]"><h3>Sustainability</h3></div>
          <div data-aos="fade-left" data-aos-duration="200" className="text-[34px] lg:text-[55px] leading-[50px]"><h2>Building prosperity & self-sufficiency</h2></div>
